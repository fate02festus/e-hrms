			...
			?>
				<form method = "POST" enctype = "multipart/form-data">
					...
					<div class = "form-inline">
						...
						<input class = "form-control" value = "<?php echo $f['firstname'] ?>" name = "firstname" type = "text"  required = "required" pattern="[0-9]{9,12}" title="Enter numerics only"> 
						&nbsp;&nbsp;&nbsp;
						<label for = "middlename">Middle Name:</label>
						<input class = "form-control" value = "<?php echo $f['middlename'] ?>" name = "middlename" placeholder = "(Optional)" type = "text" pattern="[0-9]{9,12}" title="Enter numerics only"> 
						&nbsp;&nbsp;&nbsp;
						<label for = "lastname">Lastname:</label>
						<input class = "form-control" value = "<?php echo $f['lastname'] ?>" name = "lastname" type = "text" required = "required" pattern="[0-9]{9,12}" title="Enter numerics only"> 
					</div>
					<br />
					<div class ="form-inline">
						<label for = "birthdate">Birthdate:</label>
						<input class = "form-control" value = "<?php echo $f['birthdate'] ?>"  name = "date" id= "date" type = "date" required = "required" data-relmin="-120" data-relmax="0" onchange="getDate(this.value)" required = "required">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<label for = "address">Phone No.:</label>
						<input class = "form-control" value = "<?php echo $f['phone'] ?>" name = "phone" type = "text" maxlength="12" minlength="7" required = "required" pattern="[0-9]{9,12}" title="Enter numerics only"> 
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<label for = "address">Address:</label>
						<input class = "form-control" value = "<?php echo $f['address'] ?>" name = "address" type = "text" required = "required" pattern="[0-9]{9,12}" title="Enter numerics only"> 
