		...
		<div class = "panel panel-primary">
			...
			<div class = "panel-body">
				...
				<table id = "table" class = "display" width = "100%" cellspacing = "0">
					...
					<tbody>
					<?php
						$query = $conn->query("SELECT *,hrecold_temp.hospital as hospital FROM `patient` left join hrecold_temp on hrecold_temp.pat_no=patient.pat_no ORDER BY patient.pat_no DESC") or die(mysqli_error());
