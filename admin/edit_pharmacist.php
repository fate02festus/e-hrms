...
<body>
	...
	<div id = "content">
		...
		<?php
		 include "include/config.php"; 
		    $query = $conn->query(" SELECT * FROM `pharmacist` WHERE `user_id` = '$_GET[id]'") or die(mysqli_error());
	...
	<div class = "panel-heading">
				<label>EDIT PHARMACIST</label>
				<a href = "pharmacist.php" class = "btn btn-sm btn-info" style = "float:right; margin-top:-5px;"><span class = "glyphicon glyphicon-hand-right"></span> BACK</a>
			</div>
				...
				<form id = "form_user" method = "POST" enctype = "multi-part/form-data">
					...
					<div class = "panel-body">
						<div class = "form-group">
							...
							<input class = "form-control" value = "<?php echo $fetch['username']?>" name = "username" placeholder="Enter Username" type = "email" required = "required">
						</div>
						<div class = "form-group">	
						...
						<div class = "form-group">
							...
							<input class = "form-control" type = "number" min="1" value = "<?php echo $fetch['contact']?>" name = "contacts" required = "required" pattern="[0-9]{7,12}" title="Enter numerics value of length between 9 and 12 characters">
						</div>
						<div class = "form-group">
						...
						<div class = "form-group">
							...
							<button class = "btn btn-warning" name = "edit_pharmacist" ><span class = "glyphicon glyphicon-edit"></span> SAVE</button>
							<br />
					</div>	
