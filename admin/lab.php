	...
	<div id = "content">
		...
		<div id = "add" class = "panel panel-success">	
			<div class = "panel-heading">
				<label>ADD LAB TECHNISIAN</label>
				...
				<form id = "form_user" method = "POST" enctype = "multi-part/form-data">
					...
					<div class = "panel-body">
						<div class = "form-group">
							<label for = "username">Labtec Code: </label>
						...
						<div class = "form-group">
							...
							<input class = "form-control" type = "text" name = "lastname" pattern="[A-Za-z]{1,15}" title="Enter characters only" required="required">
						</div>
						<div class = "form-group">
						...
						<div class = "form-group">
							...
							<input class = "form-control" type = "number" min="1" name = "idno" required = "required" pattern="[0-9]{7,8}"  title="Enter characters value of length between 7 and 8 characters">
						</div>
						<div class = "form-group">
							<label for = "lastname">Physical Address: </label>
							<input class = "form-control" type = "text" name = "address" pattern="[A-Za-z]{1,15}" title="Enter characters only">
						</div>
						<div class = "form-group">
		...
		<div class = "panel panel-primary">
			<div class = "panel-heading">
				<label>ACCOUNTS /LAB TECHNISIAN</Label>
			</div>
			<div class = "panel-body">
				...
				<table id = "table" class = "display" width = "100%" cellspacing = "0">
					...
					<tbody>
					<?php
						$query = $conn->query("SELECT * FROM `labtech` ORDER BY `user_id` DESC") or die(mysqli_error());
					...
					?>
						<tr>
							...
							<td><center><a href = "edit_labtech.php?id=<?php echo $fetch['user_id']?>&lastname=<?php echo $fetch['lastname']?>"class = "btn btn-sm btn-warning"><i class = "glyphicon glyphicon-edit"></i> Update</a> <a onclick = "delete_user(this); return false;"  href = "delete_labtech.php?id=<?php echo $fetch['user_id']?>&lastname=<?php echo $fetch['lastname']?>" class = "btn btn-sm btn-danger"><i class = "glyphicon glyphicon-remove"></i> Archive</a></center></td>
						</tr>
					<?php
						}
						$conn->close();
