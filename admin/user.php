	...
	<div id = "content">
		...
		<div id = "add" class = "panel panel-success">	
			<div class = "panel-heading">
				<label>ADD DOCTOR ACCOUNT</label>
				...
				<form id = "form_user" method = "POST" enctype = "multi-part/form-data">
					...
					<div class = "panel-body">
						<div class = "form-group">
							<label for = "username">Doctor Code: </label>
						...
						<div class = "form-group">
							...
							<input type = "text" name = "firstname"  pattern="[A-Za-z]{1,15}" title="Enter characters only" class = "form-control" required="required">
						</div>
						<div class = "form-group">
						...
						<div class = "form-group">
							...
							<input class = "form-control" type = "number" minlength="9" maxlength="12" name = "contacts" required = "required" pattern="[0-9]{9,12}" title="Enter numerics value of length between 9 and 12 characters">
						</div>
						<div class = "form-group">
						...
						<div class = "form-group">
							...
							<input class = "form-control" type = "text" name = "address" pattern="[A-Za-z]{1,15}" pattern="[A-Za-z]{1,15}" title="Enter characters only">
						</div>
						<div class = "form-group">
		...
		<div class = "panel panel-primary">
			...
			<div class = "panel-body">
				...
				<table id = "table" class = "display" width = "100%" cellspacing = "0">
					...
					<tbody>
					<?php
						$query = $conn->query("SELECT * FROM `doctor` ORDER BY `user_id` DESC") or die(mysqli_error());
