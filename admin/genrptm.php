...
<div id = "content">
		...
		<div id="chartContainer" style="width: 100%; height: 400px">
				<div class = "well">
					<form id = "form_dental" method = "POST" action="pdfspt.php" enctype = "multipart/form-data">
					...
					<div class = "form-inline">
					   <label style = "font-size:18px;">Address.</label>
						...
						<input type="submit" value="Medical Report" class="btn btn-info" name="print_patient"/>
