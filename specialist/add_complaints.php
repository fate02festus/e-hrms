...
require_once 'logincheck.php';
	...
	if(ISSET($_POST['save_complaints'])){
		...
		$ins="update `patient_hrecold` set remark='$remarks',specialist_remarks='$specs',add_to_lab='$addspec' where pat_no ='$itr_no'and date='$date'" or die(mysqli_error());
