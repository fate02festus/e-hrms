	...
	<br />
		...
		<div class = "panel panel-success">	
			...
			<?php
				...
				$f = $q->fetch_array();
				$q1 = $conn->query("SELECT * FROM `hrecold_temp` where `pat_no` = '$_SESSION[pat_no]'") or die(mysqli_error());
				$f1 = $q1->fetch_array();
			
			  $q11 = $conn->query("SELECT * FROM `hrecold_temp` where `pat_no` = '$_SESSION[pat_no]' and `date`='$date'") or die(mysqli_error());
				$f11 = $q11->fetch_array();  
			?>
